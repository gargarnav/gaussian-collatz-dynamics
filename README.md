...
| **E** | Chaotic / fractal | Period-40 cycle (proved stable); basin boundary D ≈ 1.61 |
...
reveals three principal findings: (i) a periodic orbit of length 40, 
proved locally asymptotically stable with contraction factor 2^-45, 
(ii) orbits live in the ring of dyadic Gaussian rationals Z[1/2][i], and 
(iii) the stability boundary is fractal with dimension D ≈ 1.61.
...
│   ├── exact_cycle.py          Exact rational arithmetic; proves 40-cycle stability
...
│   ├── initial_survey.py       Evaluation of stability over lattice points
...
- Box-counting dimension **D ≈ 1.61** (R² ≈ 0.966).
- Boundary computed on a **10,000 × 10,000 grid** over [−50, 50]².
- Uses continuous orbit iteration in ℂ.
